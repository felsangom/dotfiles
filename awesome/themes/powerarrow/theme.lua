...
theme.wallpaper                                 = "/home/felipe/Imagens/wall.jpg"
theme.font                                      = "Ubuntu 9"
...
local mytextclock = wibox.widget.textclock(markup("white", "%d/%m/%Y") .. markup("white", " ") .. markup("white", " %H:%M "))
...
function theme.at_screen_connect(s)
    ...
    -- Tags
    local names = { "web", "code", "terminal", "misc", "personal" }
