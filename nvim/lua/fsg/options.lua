...
-- --- COMPORTAMENTO GERAL ---
o.confirm = true -- Pergunta se quer salvar ao sair com mudanças
...
-- --- PERFORMANCE & TIMING ---
o.updatetime = 250
-- o.timeoutlen = 300 -- Opcional: Se sentir que seus atalhos compostos demoram para registrar

-- --- FOLDING (MODERNIZADO) ---
o.fillchars:append({ fold = " " })
o.foldlevel = 99
o.foldenable = false -- Começa com tudo aberto
o.foldmethod = "expr"
